...
(N'ENTIDAD_GEOGRAFICA',282),(N'POBLACION',17024),(N'NOC',236),(N'ATLETA',338772),
(N'SEDE',42),(N'EDICION_OLIMPICA',61),(N'DEPORTE',65),(N'DISCIPLINA',117),
(N'EVENTO',3106),(N'PARTICIPACION',826605);
...
(N'atletas',338772,(SELECT COUNT_BIG(*) FROM olympics.ATLETA),CASE WHEN (SELECT COUNT_BIG(*) FROM olympics.ATLETA)=338772 THEN N'PASS' ELSE N'FAIL' END,N'Atletas finales'),
(N'participaciones',826605,(SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION),CASE WHEN (SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION)=826605 THEN N'PASS' ELSE N'FAIL' END,N'Participaciones finales');
