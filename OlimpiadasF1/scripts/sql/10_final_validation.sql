...
(N'ENTIDAD_GEOGRAFICA',282),(N'POBLACION',17024),(N'NOC',236),(N'ATLETA',336419),
(N'SEDE',42),(N'EDICION_OLIMPICA',61),(N'DEPORTE',65),(N'DISCIPLINA',117),
(N'EVENTO',3007),(N'PARTICIPACION',733414);
...
(N'atletas',336419,(SELECT COUNT_BIG(*) FROM olympics.ATLETA),CASE WHEN (SELECT COUNT_BIG(*) FROM olympics.ATLETA)=336419 THEN N'PASS' ELSE N'FAIL' END,N'Atletas finales'),
(N'participaciones',733414,(SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION),CASE WHEN (SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION)=733414 THEN N'PASS' ELSE N'FAIL' END,N'Participaciones finales');
