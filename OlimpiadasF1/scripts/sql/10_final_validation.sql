...
(N'EVENTO',2986),(N'PARTICIPACION',713675);
...
(N'participaciones',713675,(SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION),CASE WHEN (SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION)=713675 THEN N'PASS' ELSE N'FAIL' END,N'Participaciones finales');
