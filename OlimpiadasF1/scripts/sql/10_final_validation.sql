...
(N'SEDE',42),(N'EDICION_OLIMPICA',61),(N'DEPORTE',65),(N'DISCIPLINA',117),
 (N'EVENTO',2986),(N'PARTICIPACION',712658);
...
(N'participaciones',712658,(SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION),CASE WHEN (SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION)=712658 THEN N'PASS' ELSE N'FAIL' END,N'Participaciones finales');
