...
(N'SEDE',42),(N'EDICION_OLIMPICA',61),(N'DEPORTE',65),(N'DISCIPLINA',117),
 (N'EVENTO',2986),(N'PARTICIPACION',712020);
...
(N'participaciones',712020,(SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION),CASE WHEN (SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION)=712020 THEN N'PASS' ELSE N'FAIL' END,N'Participaciones finales');
