...
(N'conteo.ATLETA',338772,(SELECT COUNT_BIG(*) FROM olympics.ATLETA),N'PENDIENTE',N'Conteo final'),
...
(N'conteo.EVENTO',3106,(SELECT COUNT_BIG(*) FROM olympics.EVENTO),N'PENDIENTE',N'Conteo final'),
(N'conteo.PARTICIPACION',826605,(SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION),N'PENDIENTE',N'Conteo final');
