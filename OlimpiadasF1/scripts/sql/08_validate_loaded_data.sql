...
(N'conteo.ATLETA',336419,(SELECT COUNT_BIG(*) FROM olympics.ATLETA),N'PENDIENTE',N'Conteo final'),
...
(N'conteo.EVENTO',3007,(SELECT COUNT_BIG(*) FROM olympics.EVENTO),N'PENDIENTE',N'Conteo final'),
(N'conteo.PARTICIPACION',733414,(SELECT COUNT_BIG(*) FROM olympics.PARTICIPACION),N'PENDIENTE',N'Conteo final');
