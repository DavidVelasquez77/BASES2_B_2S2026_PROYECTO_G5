...
BEGIN TRY
    ...
    /* Los CSV vigentes fueron verificados byte a byte con terminador LF
       (0x0a). Se mantiene la limpieza defensiva de CR por compatibilidad con
       copias CRLF, únicamente dentro de staging y nunca en data/processed. */
